<div id="manipulator" class="col-xs-2 col-sm-2 col-md-2">
	<div class="button-container well">
		<div class="btn-group-vertical btn-block">
			...
			<button type="button" class="btn btn-danger btn-block">Disable</button>
			<button type="button" class="btn btn-warning btn-block">Threshold</button>
		...
		<button type="button" class="btn btn-primary btn-block">Commit changes</button>
	</div>
</div>